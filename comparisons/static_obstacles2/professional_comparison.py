...
class ProfessionalComparison:
    ...
    def create_comparison_video(
        ...
        # Save with pillow (more reliable than ffmpeg)
        try:
            ...
            try:
                anim.save(
                    str(save_path).replace(".gif", ".mp4"), writer="ffmpeg", fps=20
                )
            except:
                pass
        ...
        for scenario in self.scenarios:
            ...
            for trial_idx in range(trials_per_scenario):
                ...
                try:
                    ...
                    # Skip video generation for faster processing
                    # vid_path = (
...
def main():
    ...
    comparison = ProfessionalComparison(
        ...
        output_dir="comparisons/static_obstacles2",
    )

    comparison.run_comparison(trials_per_scenario=args.trials)
