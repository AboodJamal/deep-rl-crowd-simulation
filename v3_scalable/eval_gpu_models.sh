#!/bin/bash
#SBATCH --job-name=test3_eval_gpu
...
echo "========================================"
echo "TEST3 - Evaluate FINAL GPU-Trained Model"
echo "========================================"
...
echo "Evaluating FINAL GPU model: $MODEL_PATH"
echo "This is the best model from full curriculum training!"
echo ""

# Run evaluation with videos
python evaluate_cpu_models.py \
    --model-path "$MODEL_PATH" \
    --num-agents 5 \
    --num-episodes 50 \
    --device cuda \
    --video-dir videos_gpu
