...
class ExperimentRunner:
    ...
    def _load_drl_model(self, checkpoint_path: str) -> DRLPolicyInterface:
        ...
        try:
            ...
            model = DRLPolicyInterface(checkpoint_path=checkpoint_path, device="cpu")
    ...
    def create_sosp_scenarios(self) -> List[ScenarioDefinition]:
        ...
        scenarios.append(
            ScenarioDefinition(
                ...
                obstacles=[{"position": [5.0, 0.0], "radius": 0.5}],
        ...
        scenarios.append(
            ScenarioDefinition(
                ...
                start_pos=np.array([0.0, 0.0]),
                goal_pos=np.array([10.0, 0.0]),
                obstacles=[{"position": [5.0, 0.5], "radius": 0.5}],
        ...
        scenarios.append(
            ScenarioDefinition(
                ...
                start_pos=np.array([0.0, 0.0]),
                goal_pos=np.array([10.0, 0.0]),
                obstacles=[{"position": [5.0, 0.0], "radius": 1.0}],
    ...
    def run_model_on_scenario(
        self, model, model_name: str, scenario: ScenarioDefinition, num_trials: int
    ...
    def calculate_summary_statistics(self):
        ...
        summary = {"total_scenarios": len(self.results["scenarios"]), "models": {}}
        ...
        for model_name, model_summary in summary["models"].items():
            ...
            if total > 0:
                model_summary["success_rate"] = (
                    model_summary["successful_trials"] / total
                )
